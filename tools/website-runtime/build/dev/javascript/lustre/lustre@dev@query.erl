...
-spec find_in_list(
    list(lustre@vdom@vnode:element(MRO)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(MRO), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(MRJ),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MRJ), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(MRE),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(MRE), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(MQZ), 'query'()) -> {ok,
        lustre@vdom@vnode:element(MQZ)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(MTH)),
    selector()
) -> list(lustre@vdom@vnode:element(MTH)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(MTD), selector()) -> list(lustre@vdom@vnode:element(MTD)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(MTQ)),
    selector()
) -> list(lustre@vdom@vnode:element(MTQ)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(MTM), selector()) -> list(lustre@vdom@vnode:element(MTM)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(MSY)), 'query'()) -> list(lustre@vdom@vnode:element(MSY)).
...
-spec find_all_in_children(lustre@vdom@vnode:element(MSU), 'query'()) -> list(lustre@vdom@vnode:element(MSU)).
...
-spec find_all(lustre@vdom@vnode:element(MSQ), 'query'()) -> list(lustre@vdom@vnode:element(MSQ)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
            case matches(Root, Selector) of
