...
fn added_value(
  ...
  list.fold(events, Error(Nil), fn(found, tagged) {
    case found, tagged.1 {
      ...
      | Ok(_), channel.GCounterEvent(_)
      | Ok(_), channel.LwwRegisterEvent(_)
      | Ok(_), channel.LwwMapEvent(_)
      | Ok(_), channel.MvRegisterEvent(_)
      ...
      | Error(_), channel.GCounterEvent(_)
      | Error(_), channel.LwwRegisterEvent(_)
      | Error(_), channel.LwwMapEvent(_)
      | Error(_), channel.MvRegisterEvent(_)
