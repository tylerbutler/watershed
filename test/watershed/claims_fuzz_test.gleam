...
//// harness. Uses `default_weights` (no
//// `rollback_operation`/`stashed_operation`, which the claims model does not
//// yet expose as capabilities). Convergence and the independent oracle
//// validate at every generated `Synchronize`.
////
