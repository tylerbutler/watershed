...
_build-website-lustre: snippets _website-lustre-tools
    ...
    cd website_lustre && ../tools/website-lustre-build/website_lustre_tools build watershed_site/client/guide_race watershed_site/client/sudoku watershed_site/client/directory watershed_site/client/counter_bug watershed_site/client/json_ot watershed_site/client/mv_register
