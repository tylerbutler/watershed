    ...
    && anchor_moved
  {
    ...
    False -> {
      log(
        ...
        <> " insert_a="
        <> bool_to_string(insert_ok)
        <> " insert_b="
        <> bool_to_string(insert_b_ok)
        <> " append="
        <> bool_to_string(append_ok)
        <> " out_of_bounds_rejected="
        <> bool_to_string(rejected_ok)
        <> " emoji_survived="
        <> bool_to_string(emoji_survived)
        <> " combining_survived="
        <> bool_to_string(combining_survived)
        <> " append_survived="
        <> bool_to_string(append_survived)
        <> " anchor_moved="
        <> bool_to_string(anchor_moved),
      )
      exit(1)
    }
  }
