...
//// alone, with no hand-written key constants in the app — and, crucially,
//// every tab resolves the *same* `body` channel through `ensure_text`, so
//// joiners converge on one shared document instead of seeding rivals.
