...
import grocery_triptych_lustre/bootstrap_guard.{type Feedback}
...
pub fn add_feedback(
  ...
  case two_phase_was_present, two_phase_is_present {
    ...
    _, _ -> bootstrap_guard.info("Added \"" <> item <> "\" to all three sets.")
  }
}
...
pub fn scenario_placeholder_feedback(name: String) -> Feedback {
  bootstrap_guard.info(name <> " automation lands in the next task.")
}
