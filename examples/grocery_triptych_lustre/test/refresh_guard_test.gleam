...
pub fn stale_generation_is_rejected_test() {
...
pub fn latest_generation_flushes_and_clears_pending_state_test() {
...
pub fn new_request_after_completed_flush_schedules_and_accepts_normally_test() {
  let #(state1, generation1) = refresh_guard.request(refresh_guard.idle())
