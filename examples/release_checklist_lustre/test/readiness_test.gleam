...
pub fn all_checks_complete_all_present_test() {
  release_readiness.all_checks_complete(
...
pub fn all_checks_complete_ignores_extras_test() {
...
pub fn can_propose_requires_captain_test() {
  release_readiness.can_propose(False, True, "v1.2.3", False, False)
  |> should.be_false
}

pub fn can_propose_requires_all_checks_test() {
  release_readiness.can_propose(True, False, "v1.2.3", False, False)
  |> should.be_false
}

pub fn can_propose_requires_nonblank_target_test() {
  release_readiness.can_propose(True, True, "", False, False)
  |> should.be_false
}

pub fn can_propose_requires_nonblank_target_whitespace_test() {
  release_readiness.can_propose(True, True, "   ", False, False)
  |> should.be_false
}

pub fn can_propose_blocked_while_pending_test() {
  release_readiness.can_propose(True, True, "v1.2.3", True, False)
  |> should.be_false
}

pub fn can_propose_blocked_in_submit_gap_test() {
  release_readiness.can_propose(True, True, "v1.2.3", False, True)
  |> should.be_false
}

pub fn can_propose_true_when_everything_lines_up_test() {
