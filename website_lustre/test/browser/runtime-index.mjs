...
const { record, site, fixture } = contract(import.meta.url, "site-runtime-index-contract.json");
...
await withBrowserSite(site, async (browser, origin) => {
  ...
  if (record) {
    ...
    console.log("Recorded site runtime index contract baseline.");
    return;
  }
  ...
  console.log("PASS: runtime index site contract, navigation, focus, and reveal motion.");
});
