...
const { record, site, fixture } = parity(import.meta.url, "astro-models-parity.json");
...
await withBrowserSite(site, async (browser, origin) => {
  ...
  if (record) {
    ...
    console.log("Recorded Astro models parity baseline.");
    return;
  }
  ...
  console.log("PASS: models Astro parity, mobile layout, and keyboard focus.");
});
